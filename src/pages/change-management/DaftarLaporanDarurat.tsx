...
const DaftarLaporanDarurat = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-text-dark mb-6">Daftar Laporan Darurat</h1>

      <TableWithSearch searchPlaceholder="Cari laporan darurat...">
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-primary text-primary-foreground">
                ...
                <th className="px-4 py-4 text-left font-semibold text-sm">Pelapor</th>
